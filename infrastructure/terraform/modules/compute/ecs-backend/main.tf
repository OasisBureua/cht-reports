...
#
# Reachability:
#   - cht-companion: Service Connect DNS, same namespace.
#   - Content Hub: HTTPS to a separate cluster/VPC (no Cloud Map). Packet
#     API only — cht-reports has no Aurora role.
